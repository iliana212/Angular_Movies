...
import { FiltroPeliculasComponent } from './peliculas/filtro-peliculas/filtro-peliculas';
import { DetallePeliculaComponent } from './peliculas/detalle-pelicula/detalle-pelicula';
import { esAdminGuard } from './compartidos/guards/es-admin-guard';
import { LoginComponent } from './seguridad/login/login';
import { RegistroComponent } from './seguridad/registro/registro';
import { IndiceUsuariosComponent } from './seguridad/indice-usuarios/indice-usuarios';
